...
const steps = [
  {
    ...
    step: 1,
    title: 'Harapan',
    subtitle: 'Apa harapannya buat kita ke depan?',
    placeholder: 'Tulis harapan dan impian buat kita berdua...',
    emoji: '🌟',
  },
  {
    id: 'ortu',
    ...
    subtitle: 'Apa yang mau ucaa sampein buat bapa sama mamah?',
    placeholder: 'Tulis ucapan cinta buat bapa & mamah...',
    emoji: '💝',
  },
  {
    id: 'mertua',
    ...
    subtitle: 'Apa pesan spesial dari Ucaa buat mamah sama papah?',
    placeholder: 'Tulisin juga rasa terima kasih buat mamah & papah...',
    emoji: '🙏',
  },
  {
    id: 'suami',
    ...
    subtitle: 'Terakhir nih, ada yang diucapin ga buat fikr?',
    placeholder: 'Sekarang, curahin semuanya di sini ya...',
    emoji: '💌',
  },
];
